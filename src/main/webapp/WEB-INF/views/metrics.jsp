        ...
        <div class="modal fade" id="msModal" tabindex="-1" aria-labelledby="msModalTitle" aria-hidden="true">
            ...
            <div class="modal-content">
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                <div class="form-floating">
                                    <input type="text" id="msModalMName" name="msModalMName" class="form-control">
                                    <label class="form-label" for="msModalMName" style="margin-left: 0px;">Metric Name</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-floating">
                                    <input type="text" id="msModalPgVersion" name="msModalMPgVersionFrom" class="form-control">
                                    <label class="form-label" for="msModalPgVersion" style="margin-left: 0px;">Pg Version</label>
                                </div>
                            </div>
                        </div>

                        <div class="form-floating mb-4">
                            <textarea class="form-control" id="msModalMSql" name="msModalMSql" rows="4"></textarea>
                            <label class="form-label" for="msModalMSql" style="margin-left: 0px;">Metric SQL</label>
                        </div>

                        <div class="form-floating mb-4">
                            <textarea class="form-control" id="msModalMSqlSu" name="msModalMSqlSu" rows="4"></textarea>
                            <label class="form-label" for="msModalMSqlSu" style="margin-left: 0px;">Metric Privileged SQL</label>
                        </div>

                        <div class="form-floating mb-4">
                            <textarea class="form-control" id="msModalMComment" name="msModalMComment" rows="4"></textarea>
                            <label class="form-label" for="msModalMComment" style="margin-left: 0px;">Comment</label>
                        </div>

                        <div class="form-floating mb-4">
                            <textarea class="form-control" id="msModalMColumnAttrs" name="msModalMColumnAttrs" rows="4"></textarea>
                            <label class="form-label" for="msModalMColumnAttrs" style="margin-left: 0px;">Metric Column Attributes</label>
                        </div>

                        <div class="form-floating mb-4">
                            <textarea class="form-control" id="msModalMaMetricAttrs" name="msModalMaMetricAttrs" rows="4"></textarea>
                            <label class="form-label" for="msModalMaMetricAttrs" style="margin-left: 0px;">Metric Attributes</label>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="msModalMIsActive">Active Mode</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="msModalMIsHelper" >
                                    <label class="form-check-label" for="msModalMIsHelper">Helper Mode</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="msModalMMasterOnly" >
                                    <label class="form-check-label" for="msModalMMasterOnly">Master Only Mode</label>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="msModalMStandbyOnly" >
                                    <label class="form-check-label" for="msModalMStandbyOnly">Standby Only Mode</label>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-block" id="msModalFormSubmit">Save</button>
